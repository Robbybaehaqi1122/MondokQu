...
use App\Policies\AttitudeGradePolicy;
...
use App\Policies\TahfidzTargetPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(TahfidzTarget::class, TahfidzTargetPolicy::class);
        Gate::policy(MemorizationSchedule::class, MemorizationSchedulePolicy::class);
