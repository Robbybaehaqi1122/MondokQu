...
class SantriImport implements SkipsEmptyRows, WithHeadingRow
{
    ...
    protected function mapColumns(Collection $row): array
    {
        ...
        return [
            ...
            'father_phone' => $row['no_telp_ayah'] ?? $row['father_phone'] ?? '',
            'father_education' => $row['pendidikan_ayah'] ?? $row['father_education'] ?? '',
            'father_job' => $row['pekerjaan_ayah'] ?? $row['father_job'] ?? '',
            'mother_name' => $row['nama_ibu'] ?? $row['mother_name'] ?? '',
            'mother_phone' => $row['no_telp_ibu'] ?? $row['mother_phone'] ?? '',
            'mother_education' => $row['pendidikan_ibu'] ?? $row['mother_education'] ?? '',
            'mother_job' => $row['pekerjaan_ibu'] ?? $row['mother_job'] ?? '',
            'guardian_name' => $row['nama_wali'] ?? $row['guardian_name'] ?? $row['father_name'] ?? '',
            'guardian_phone_number' => $guardianPhone,
            'guardian_relation' => $row['hubungan_wali'] ?? $row['guardian_relation'] ?? '',
            'guardian_address' => $row['alamat_wali'] ?? $row['guardian_address'] ?? '',
