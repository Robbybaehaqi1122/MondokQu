                ...
                <div class="text-center">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body p-4 p-sm-5 text-center">
                            <div class="mb-3" style="font-size: 5rem; font-weight: 800; line-height: 1; color: var(--tblr-warning);">404</div>
                            <h2 class="mb-2">Halaman Tidak Ditemukan</h2>
                            <p class="text-secondary mb-4">Halaman yang Anda tuju tidak tersedia atau telah dipindahkan.</p>
