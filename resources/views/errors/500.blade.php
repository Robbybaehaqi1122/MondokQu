                ...
                <div class="text-center">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body p-4 p-sm-5 text-center">
                            <div class="mb-3" style="font-size: 5rem; font-weight: 800; line-height: 1; color: var(--tblr-danger);">500</div>
                            <h2 class="mb-2">Terjadi Kesalahan</h2>
                            <p class="text-secondary mb-4">Maaf, terjadi kesalahan pada server. Silakan coba beberapa saat lagi.</p>
