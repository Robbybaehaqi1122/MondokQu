...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name') }} — 503 Maintenance</title>
                ...
                <div class="text-center">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body p-4 p-sm-5 text-center">
                            <div class="mb-3" style="font-size: 5rem; font-weight: 800; line-height: 1; color: var(--tblr-info);">503</div>
                            <h2 class="mb-2">Sedang Dalam Pemeliharaan</h2>
                            <p class="text-secondary mb-4">Sistem sedang dalam pemeliharaan. Silakan kembali beberapa saat lagi.</p>
