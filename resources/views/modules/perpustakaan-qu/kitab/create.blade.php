<x-app-layout>
    ...
    <form action="{{ route('perpustakaan.kitab.store') }}" method="POST">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="tahun_terbit" class="form-control @error('tahun_terbit') is-invalid @enderror" value="{{ old('tahun_terbit') }}" min="1000" max="{{ now()->year + 1 }}" placeholder="2024">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">ISBN</label>
                        <input type="text" name="isbn" class="form-control @error('isbn') is-invalid @enderror" value="{{ old('isbn') }}" placeholder="978-xxx-xxx-xxx-x">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Lokasi Rak</label>
                        <input type="text" name="lokasi_rak" class="form-control @error('lokasi_rak') is-invalid @enderror" value="{{ old('lokasi_rak') }}" placeholder="Misal: Rak A - 1">
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('perpustakaan.kitab.index') }}" class="btn btn-outline-secondary">Batal</a>
            </div>
        </div>
    </form>
</x-app-layout>
