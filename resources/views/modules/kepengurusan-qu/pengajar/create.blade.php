<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="page-title mt-1">Tambah Pengajar</h2>
            <div class="text-secondary small">Tambahkan data guru atau ustadz baru.</div>
        </div>
    </x-slot>

    <form action="{{ route('kepengurusan.pengajar.store') }}" method="POST">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="bidang_keahlian" class="form-control @error('bidang_keahlian') is-invalid @enderror" value="{{ old('bidang_keahlian') }}">
